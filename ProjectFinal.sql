...
CREATE DATABASE [Project_Final_Vertion1.2]
GO
USE [Project_Final_Vertion1.2]
GO
...
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (1, N'HW-01', N'Kìm bấm đinh', 10, 150000, N'Thân bằng thép dày xử lý bề mặt đen nhám, tay cầm bằng nhựa chất lượng cao
...
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (2,  N'HW-02', N'Dụng cụ sửa kim', 10, 100000, N'- Sản xuất bởi thương hiệu TOLSEN, được đánh giá là thương hiệu chất lượng và giá phù hợp

- Sản phẩm đạt tiêu chuẩn xuất khẩu Châu Âu', N'tools/2_0.jpg', CAST(N'2019-10-09' AS Date), 2, 1, 0.11)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (3,  N'HW-03', N'Tua vit', 10, 30000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề

- Sản phẩm chống gỉ, có độ bền cao

- Thiết kế nhỏ gọn, tinh xảo', N'tools/3_0.jpg', CAST(N'2019-10-09' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (4, N'HW-04', N'Dụng cụ ghép ', 10, 40000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề

- Sản phẩm chống gỉ, có độ bền cao

- Thiết kế nhỏ gọn, tinh xảo', N'tools/4_0.jpg', CAST(N'2019-10-09' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (5, N'HW-05', N'Cắt sắt mini', 10, 40000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề

- Sản phẩm chống gỉ, có độ bền cao

- Thiết kế nhỏ gọn, tinh xảo', N'tools/5_0.jpg', CAST(N'2019-10-09' AS Date), 3, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (6, N'HW-06', N'Kìm đa năng', 10, 70000, N'Kìm cắt FUTURO -# 441718 chuẩn DIN ISO 5745, chế tạo bằng thép hợp kim siêu cứng 60-62HRC. Sản phẩm nhập khẩu từ Đức, bảo hành tới 2 năm.', N'tools/6_0.jpg', CAST(N'2019-10-09' AS Date), 2, 1, 0.15)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (7, N'HW-07', N'Bộ tua vit mini', 10, 50000, N'- Là sản phẩm chuyên dụng trong nhiều ngành nghề

- Sản phẩm chống gỉ, có độ bền cao

- Thiết kế nhỏ gọn, tinh xảo', N'tools/7_0.jpg', CAST(N'2019-10-09' AS Date), 3, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (8, N'HW-08', N'Tua vit FAVO', 10, 30000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề

Sản phẩm chống gỉ, có độ bền cao
', N'tools/8_0.jpg', CAST(N'2019-10-09' AS Date), 2, 1, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (9,  N'HW-09', N'Hút bụi mini cầm tay', 12, 20000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề
Thiết kế nhỏ gọn, tinh xảo', N'tools/9_0.jpg', CAST(N'2019-10-09' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (10, N'HW-010', N'Miếng mút dán', 12, 10000, N'Là sản phẩm chuyên dụng trong nhiều ngành nghề', N'tools/10_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.2)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (11, N'HW-011', N'Kìm Nhật đa năng', 13, 40000, N'Thiết kế mới mẻ, độc lạ. Sử dụng cho nhiều ngành nghề.
- Sản phẩm chống gỉ, có độ bền cao', N'tools/11_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.13)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (12, N'HW-012', N'Dụng cụ cạy, mở mini', 13, 20000, N'Thiết kế nhỏ gọn, dễ cầm theo', N'tools/12_0.jpg', CAST(N'2019-10-18' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (13, N'HW-013', N'Miếng dán nhựa déo', 14, 30000, N'Nhỏ gọn, không bị đau tay. Lớp dính chặt chẽ không bị bong tróc', N'tools/13_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.1)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (14, N'HW-014', N'Bộ làm vườn mini', 14, 50000, N'Thiết kế nhỏ gọn, thuận tiện cầm tay. Phù hợp trồng chậu nhỏ', N'tools/14_0.jpg', CAST(N'2019-10-18' AS Date), 2, 14, 0.1)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (15, N'HW-015', N'KÌm vặn mini', 14, 10000, N'thiết kế nhỏ gọn, tinh xảo, nhiều màu sắc', N'tools/15_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (16, N'HW-016', N'Bộ khắc gỗ cầm tay', 14, 120000, N'Thiết kế nhỏ gọn, tinh xảo', N'tools/16_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (17, N'HW-017', N'Làm nhuyễn ', 14, 50000, N'•	Sản phẩm làm bằng inox cao cấp , không bị gỉ sét, an toàn cho sức khỏe.
•	Dễ dàng lau rửa dụng cụ sau khi sử dụng xong
•	Kích thước: 19.5 x 6.5 cm', N'tools/17_0.jpg', CAST(N'2019-10-18' AS Date), 2, 8, 0.09)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (18, N'HW-018', N'Bộ cờ lê, tua vit', 14, 70000, N'•	Sản phẩm làm bằng inox cao cấp , không bị gỉ sét, an toàn cho sức khỏe.
•	Dễ dàng lau rửa dụng cụ sau khi sử dụng xong
•	Kích thước: 19.5 x 6.5 cm', N'tools/18_0.jpg', CAST(N'2019-10-18' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (19,N'HW-019', N'Mũi khoan', 14, 40000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/19_0.jpg', CAST(N'2019-10-18' AS Date), 2, 1, 0.15)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (20,N'HW-020', N'DỤng cụ tháo ốc vit', 14, 50000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/20_0.jpg', CAST(N'2019-10-18' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (21,N'HW-021', N'Bộ tháo lắp', 14, 200000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/21_0.jpg', CAST(N'2019-10-18' AS Date), 1, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (22,N'HW-022', N'Dụng cụ chống xước', 14, 40000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/22_0.jpg', CAST(N'2019-10-18' AS Date), 1, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (23,N'HW-023', N'Cuộn dây đồng mini', 14, 50000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/23_0.jpg', CAST(N'2019-10-18' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (24,N'HW-024', N'Túi đựng dụng cụ', 14, 100000, N'- Sản phẩm chống xước, có độ bền cao', N'tools/24_0.jpg', CAST(N'2019-10-18' AS Date), 2, 10, 0.14)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (25,N'HW-025', N'Băng dính dán ', 14, 12000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/25_0.jpg', CAST(N'2019-10-18' AS Date), 3, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (26,N'HW-026', N'Đinh lắp ráp gỗ', 14, 10000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/26_0.jpg', CAST(N'2019-10-18' AS Date), 3, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (27,N'HW-027', N'Hộp ốc vít nhiều kích thước', 14, 100000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/27_0.jpg', CAST(N'2019-10-18' AS Date), 3, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (28,N'HW-028', N'Răng cưa ', 14, 30000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/28_0.jpg', CAST(N'2019-10-18' AS Date), 1, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (29,N'HW-029', N'Đầu bọc mũi khoan', 14, 10000, N'- Sản phẩm chống gỉ, có độ bền cao', N'tools/29_0.jpg', CAST(N'2019-10-18' AS Date), 3, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (30,N'HW-030', N'Cuộn dây đồng 10cm', 14, 70000, N'- Sản phẩm chống gỉ, có độ bền cao. Đường kính 10cm', N'tools/30_0.jpg', CAST(N'2019-10-18' AS Date), 1, 1, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (31,N'HW-031', N'Bộ dao đa năng', 14, 265000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/31_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (32,N'HW-032', N'Máy hút bụi', 14, 406000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/32_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.03)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (33,N'HW-033', N'Máy lọc nước', 14, 329000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/33_0.jpg', CAST(N'2019-10-18' AS Date), 3, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (34,N'HW-034', N'Dụng cụ đựng rau', 14, 340000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/34_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.16)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (35,N'HW-035', N'Thảm trải nhà', 14, 454000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/35_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (36,N'HW-036', N'Dung cụ lau nhà', 14, 483000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/36_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.1)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (37,N'HW-037', N'Dụng cụ đào bới', 14, 359000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/37_0.jpg', CAST(N'2019-10-18' AS Date), 1, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (38,N'HW-038', N'Máy vắt cam', 14, 164000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/38_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.2)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (39,N'HW-039', N'Máy say sinh tố', 14, 394000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/39_0.jpg', CAST(N'2019-10-18' AS Date), 2, 2, 0.13)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (40,N'HW-040', N'Máy đánh trứng', 14, 292000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/40_0.jpg', CAST(N'2019-10-18' AS Date), 1, 2, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (41,N'HW-041', N'Bộ dao đa năng', 14, 210000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/41_0.jpg', CAST(N'2019-10-18' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (42,N'HW-042', N'Máy hút bụi', 14, 488000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/42_0.jpg', CAST(N'2019-10-18' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (43,N'HW-043', N'Máy lọc nước', 14, 241000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/43_0.jpg', CAST(N'2019-10-18' AS Date), 2, 3, 0.1)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (44,N'HW-044', N'Dụng cụ đựng rau', 14, 262000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/44_0.jpg', CAST(N'2019-10-18' AS Date), 1, 3, 0)
...
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (46,N'HW-046', N'Dung cụ lau nhà', 14, 346000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/46_0.jpg', CAST(N'2019-10-18' AS Date), 2, 3, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (47,N'HW-047', N'Dụng cụ đào bới', 14, 387000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/47_0.jpg', CAST(N'2019-10-18' AS Date), 2, 3, 0.19)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (48,N'HW-048', N'Máy vắt cam', 14, 476000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/48_0.jpg', CAST(N'2019-10-18' AS Date), 2, 3, 0.12)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (49,N'HW-049', N'Máy say sinh tố', 14, 187000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/49_0.jpg', CAST(N'2019-10-18' AS Date), 1, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (50,N'HW-050', N'Máy đánh trứng', 14, 393000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/50_0.jpg', CAST(N'2019-10-18' AS Date), 1, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (51,N'HW-051', N'Bộ dao đa năng', 14, 265000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/51_0.jpg', CAST(N'2019-10-27' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (52,N'HW-052', N'Máy hút bụi', 14, 160000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/52_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (53,N'HW-053', N'Máy lọc nước', 14, 257000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/53_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.14)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (54,N'HW-054', N'Dụng cụ đựng rau', 14, 336000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/54_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (55,N'HW-055', N'Thảm trải nhà', 14, 374000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/55_0.jpg', CAST(N'2019-10-27' AS Date), 1, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (56,N'HW-056', N'Dung cụ lau nhà', 14, 324000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/56_0.jpg', CAST(N'2019-10-27' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (57,N'HW-057', N'Dụng cụ đào bới', 14, 338000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/57_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (58,N'HW-058', N'Máy vắt cam', 14, 379000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/58_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (59,N'HW-059', N'Máy say sinh tố', 14, 300000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/59_0.jpg', CAST(N'2019-10-27' AS Date), 2, 3, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (60,N'HW-060', N'Máy đánh trứng', 14, 331000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'tools/60_0.jpg', CAST(N'2019-10-27' AS Date), 3, 3, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (61,N'HW-061', N'Bộ dao đa năng', 20, 203000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/61_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (62,N'HW-062', N'Máy hút bụi', 20, 265000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/62_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (63,N'HW-063', N'Máy lọc nước', 20, 410000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/63_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (64,N'HW-064', N'Dụng cụ đựng rau', 20, 158000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/64_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (65,N'HW-065', N'Thảm trải nhà', 20, 379000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/65_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (66,N'HW-066', N'Dung cụ lau nhà', 20, 453000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/66_0.jpg', CAST(N'2019-11-01' AS Date), 1, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (67,N'HW-067', N'Dụng cụ đào bới', 20, 332000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/67_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (68,N'HW-068', N'Máy vắt cam', 20, 193000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/68_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.19)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (69,N'HW-069', N'Máy say sinh tố', 20, 403000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/69_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (70,N'HW-070', N'Máy đánh trứng', 20, 276000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/70_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (71,N'HW-071', N'Bộ dao đa năng', 20, 224000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/71_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.09)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (72,N'HW-072', N'Máy hút bụi', 20, 289000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/72_0.jpg', CAST(N'2019-11-01' AS Date), 1, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (73,N'HW-073', N'Máy lọc nước', 20, 351000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/73_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (74,N'HW-074', N'Dụng cụ đựng rau', 20, 217000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/74_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (75,N'HW-075', N'Thảm trải nhà', 20, 467000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/75_0.jpg', CAST(N'2019-11-01' AS Date), 2, 4, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (76,N'HW-076', N'Dung cụ lau nhà', 20, 294000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/76_0.jpg', CAST(N'2019-11-01' AS Date), 1, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (77,N'HW-077', N'Dụng cụ đào bới', 20, 400000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/77_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (78,N'HW-078', N'Máy vắt cam', 20, 279000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/78_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (79,N'HW-079', N'Máy say sinh tố', 20, 463000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/79_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (80,N'HW-080', N'Máy đánh trứng', 20, 208000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/80_0.jpg', CAST(N'2019-11-01' AS Date), 3, 4, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (81,N'HW-081', N'Bộ dao đa năng', 10, 389000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/81_0.jpg', CAST(N'2019-11-03' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (82,N'HW-082', N'Máy hút bụi', 10, 266000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/82_0.jpg', CAST(N'2019-11-03' AS Date), 2, 5, 0.12)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (83,N'HW-083', N'Máy lọc nước', 10, 377000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/83_0.jpg', CAST(N'2019-11-03' AS Date), 2, 5, 0.14)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (84,N'HW-084', N'Dụng cụ đựng rau', 10, 455000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/84_0.jpg', CAST(N'2019-11-03' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (85,N'HW-085', N'Thảm trải nhà', 10, 231000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/85_0.jpg', CAST(N'2019-11-03' AS Date), 2, 5, 0.16)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (86,N'HW-086', N'Dung cụ lau nhà', 10, 161000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/86_0.jpg', CAST(N'2019-11-03' AS Date), 3, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (87,N'HW-087', N'Dụng cụ đào bới', 10, 410000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/87_0.jpg', CAST(N'2019-11-03' AS Date), 2, 5, 0.15)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (88,N'HW-088', N'Máy vắt cam', 10, 245000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/88_0.jpg', CAST(N'2019-11-03' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (89,N'HW-089', N'Máy say sinh tố', 10, 280000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/89_0.jpg', CAST(N'2019-11-03' AS Date), 3, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (90,N'HW-090', N'Máy đánh trứng', 10, 165000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/90_0.jpg', CAST(N'2019-11-03' AS Date), 2, 5, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (91,N'HW-091', N'Bộ dao đa năng', 10, 496000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/91_0.jpg', CAST(N'2019-11-03' AS Date), 3, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (92,N'HW-092', N'Máy hút bụi', 10, 398000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/92_0.jpg', CAST(N'2019-11-04' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (93,N'HW-093', N'Máy lọc nước', 10, 468000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/93_0.jpg', CAST(N'2019-11-04' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (94,N'HW-094', N'Dụng cụ đựng rau', 10, 288000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/94_0.jpg', CAST(N'2019-11-04' AS Date), 2, 5, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (95,N'HW-095', N'Thảm trải nhà', 10, 359000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/95_0.jpg', CAST(N'2019-11-04' AS Date), 2, 5, 0.11)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (96,N'HW-096', N'Dung cụ lau nhà', 10, 450000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/96_0.jpg', CAST(N'2019-11-04' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (97,N'HW-097', N'Dụng cụ đào bới', 10, 268000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/97_0.jpg', CAST(N'2019-11-04' AS Date), 3, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (98,N'HW-098', N'Máy vắt cam', 10, 366000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/98_0.jpg', CAST(N'2019-11-04' AS Date), 1, 5, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (99,N'HW-099', N'Máy say sinh tố', 10, 474000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/99_0.jpg', CAST(N'2019-11-04' AS Date), 2, 5, 0.04)
GO
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (100, N'HW-100', N'Máy đánh trứng', 10, 210000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Measurements/100_0.jpg', CAST(N'2019-11-04' AS Date), 2, 5, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (101, N'HW-101', N'Bộ dao đa năng', 10, 347000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/101_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.18)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (102, N'HW-102', N'Máy hút bụi', 10, 250000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/102_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.11)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (103, N'HW-103', N'Máy lọc nước', 10, 471000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/103_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (104, N'HW-104', N'Dụng cụ đựng rau', 10, 335000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/104_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (105, N'HW-105', N'Thảm trải nhà', 10, 414000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/105_0.jpg', CAST(N'2019-11-08' AS Date), 3, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (106, N'HW-106', N'Dung cụ lau nhà', 10, 333000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/106_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (107, N'HW-107', N'Dụng cụ đào bới', 10, 318000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/107_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (108, N'HW-108', N'Máy vắt cam', 10, 232000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/108_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (109, N'HW-109', N'Máy say sinh tố', 10, 231000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/109_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (110, N'HW-110', N'Máy đánh trứng', 10, 200000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/110_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.1)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (111, N'HW-111', N'Bộ dao đa năng', 10, 158000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/111_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.03)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (112, N'HW-112', N'Máy hút bụi', 10, 412000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/112_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.04)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (113, N'HW-113', N'Máy lọc nước', 10, 353000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/113_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.19)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (114, N'HW-114', N'Dụng cụ đựng rau', 10, 408000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/114_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (115, N'HW-115', N'Thảm trải nhà', 10, 362000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/115_0.jpg', CAST(N'2019-11-08' AS Date), 2, 7, 0.04)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (116, N'HW-116', N'Dung cụ lau nhà', 10, 243000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/116_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (117, N'HW-117', N'Dụng cụ đào bới', 10, 272000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/117_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (118, N'HW-118', N'Máy vắt cam', 10, 427000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/118_0.jpg', CAST(N'2019-11-08' AS Date), 3, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (119, N'HW-119', N'Máy say sinh tố', 10, 408000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/119_0.jpg', CAST(N'2019-11-08' AS Date), 1, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (120, N'HW-120', N'Máy đánh trứng', 10, 337000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/120_0.jpg', CAST(N'2019-11-08' AS Date), 3, 7, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (121, N'HW-121', N'Bộ dao đa năng', 10, 190000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/121_0.jpg', CAST(N'2019-11-10' AS Date), 3, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (122, N'HW-122', N'Máy hút bụi', 10, 210000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/122_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (123, N'HW-123', N'Máy lọc nước', 10, 188000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/123_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (124, N'HW-124', N'Dụng cụ đựng rau', 10, 205000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/124_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (125, N'HW-125', N'Thảm trải nhà', 10, 202000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/125_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (126, N'HW-126', N'Dung cụ lau nhà', 10, 227000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/126_0.jpg', CAST(N'2019-11-10' AS Date), 2, 8, 0.12)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (127, N'HW-127', N'Dụng cụ đào bới', 10, 193000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/127_0.jpg', CAST(N'2019-11-10' AS Date), 2, 8, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (128, N'HW-128', N'Máy vắt cam', 10, 440000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/128_0.jpg', CAST(N'2019-11-10' AS Date), 3, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (129, N'HW-129', N'Máy say sinh tố', 10, 307000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/129_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (130, N'HW-130', N'Máy đánh trứng', 10, 426000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/130_0.jpg', CAST(N'2019-11-10' AS Date), 1, 8, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (131, N'HW-131', N'Bộ dao đa năng', 10, 229000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/131_0.jpg', CAST(N'2019-11-10' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (132, N'HW-132', N'Máy hút bụi', 10, 291000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/132_0.jpg', CAST(N'2019-11-10' AS Date), 2, 9, 0.14)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (133, N'HW-133', N'Máy lọc nước', 10, 473000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/133_0.jpg', CAST(N'2019-11-10' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (134, N'HW-134', N'Dụng cụ đựng rau', 10, 309000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/134_0.jpg', CAST(N'2019-11-10' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (135, N'HW-135', N'Thảm trải nhà', 10, 240000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/135_0.jpg', CAST(N'2019-11-10' AS Date), 2, 9, 0.11)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (136, N'HW-136', N'Dung cụ lau nhà', 10, 258000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/136_0.jpg', CAST(N'2019-11-10' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (137, N'HW-137', N'Dụng cụ đào bới', 10, 209000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/137_0.jpg', CAST(N'2019-11-10' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (138, N'HW-138', N'Máy vắt cam', 10, 256000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/138_0.jpg', CAST(N'2019-11-10' AS Date), 2, 9, 0.04)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (139, N'HW-139', N'Máy say sinh tố', 10, 402000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/139_0.jpg', CAST(N'2019-11-10' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (140, N'HW-140', N'Máy đánh trứng', 10, 494000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/140_0.jpg', CAST(N'2019-11-10' AS Date), 2, 9, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (141, N'HW-141', N'Bộ dao đa năng', 10, 260000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/141_0.jpg', CAST(N'2019-11-10' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (142, N'HW-142', N'Máy hút bụi', 10, 157000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/142_0.jpg', CAST(N'2019-11-11' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (143, N'HW-143', N'Máy lọc nước', 10, 405000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/143_0.jpg', CAST(N'2019-11-11' AS Date), 2, 9, 0.16)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (144, N'HW-144', N'Dụng cụ đựng rau', 10, 476000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/144_0.jpg', CAST(N'2019-11-11' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (145, N'HW-145', N'Thảm trải nhà', 10, 445000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/145_0.jpg', CAST(N'2019-11-11' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (146, N'HW-146', N'Dung cụ lau nhà', 10, 233000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/146_0.jpg', CAST(N'2019-11-11' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (147, N'HW-147', N'Dụng cụ đào bới', 10, 329000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/147_0.jpg', CAST(N'2019-11-11' AS Date), 3, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (148, N'HW-148', N'Máy vắt cam', 10, 344000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/148_0.jpg', CAST(N'2019-11-11' AS Date), 2, 9, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (149, N'HW-149', N'Máy say sinh tố', 10, 314000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/149_0.jpg', CAST(N'2019-11-11' AS Date), 2, 9, 0.13)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (150, N'HW-150', N'Máy đánh trứng', 10, 392000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'improvement/150_0.jpg', CAST(N'2019-11-11' AS Date), 1, 9, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (151, N'HW-151', N'Bộ dao đa năng', 10, 208000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/201_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (152, N'HW-152', N'Máy hút bụi', 10, 330000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/202_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.16)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (153, N'HW-153', N'Máy lọc nước', 10, 317000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/203_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (154, N'HW-154', N'Dụng cụ đựng rau', 10, 444000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/204_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (155, N'HW-155', N'Thảm trải nhà', 10, 354000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/205_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.01)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (156, N'HW-156', N'Dung cụ lau nhà', 10, 156000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/206_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (157, N'HW-157', N'Dụng cụ đào bới', 10, 491000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/207_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (158, N'HW-158', N'Máy vắt cam', 10, 386000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/208_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.09)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (159, N'HW-159', N'Máy say sinh tố', 10, 165000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/209_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (160, N'HW-160', N'Máy đánh trứng', 10, 376000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/210_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.02)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (161, N'HW-161', N'Bộ dao đa năng', 10, 224000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/211_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (162, N'HW-162', N'Máy hút bụi', 10, 285000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/212_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (163, N'HW-163', N'Máy lọc nước', 10, 155000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/213_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (164, N'HW-164', N'Dụng cụ đựng rau', 10, 279000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/214_0.jpg', CAST(N'2019-11-11' AS Date), 1, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (165, N'HW-165', N'Thảm trải nhà', 10, 190000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/215_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (166, N'HW-166', N'Dung cụ lau nhà', 10, 494000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/216_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.03)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (167, N'HW-167', N'Dụng cụ đào bới', 10, 248000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/217_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.14)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (168, N'HW-168', N'Máy vắt cam', 10, 240000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/218_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (169, N'HW-169', N'Máy say sinh tố', 10, 323000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/219_0.jpg', CAST(N'2019-11-11' AS Date), 2, 14, 0.12)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (170, N'HW-170', N'Máy đánh trứng', 10, 497000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/220_0.jpg', CAST(N'2019-11-11' AS Date), 3, 14, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (171, N'HW-171', N'Bộ dao đa năng', 10, 475000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/221_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (172, N'HW-172', N'Máy hút bụi', 10, 387000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/222_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
...
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (174, N'HW-174', N'Dụng cụ đựng rau', 10, 185000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/224_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (175, N'HW-175', N'Thảm trải nhà', 10, 443000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/225_0.jpg', CAST(N'2019-11-11' AS Date), 2, 15, 0.19)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (176, N'HW-176', N'Dung cụ lau nhà', 10, 246000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/226_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (177, N'HW-177', N'Dụng cụ đào bới', 10, 374000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/227_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (178, N'HW-178', N'Máy vắt cam', 10, 196000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/228_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (179, N'HW-179', N'Máy say sinh tố', 10, 318000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/229_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (180, N'HW-180', N'Máy đánh trứng', 10, 187000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/230_0.jpg', CAST(N'2019-11-11' AS Date), 2, 15, 0.08)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (181, N'HW-181', N'Bộ dao đa năng', 10, 420000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/231_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (182, N'HW-182', N'Máy hút bụi', 10, 323000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/232_0.jpg', CAST(N'2019-11-11' AS Date), 2, 15, 0.07)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (183, N'HW-183', N'Máy lọc nước', 10, 421000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/233_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (184, N'HW-184', N'Dụng cụ đựng rau', 10, 483000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/234_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (185, N'HW-185', N'Thảm trải nhà', 10, 398000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/235_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (186, N'HW-186', N'Dung cụ lau nhà', 10, 295000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/236_0.jpg', CAST(N'2019-11-11' AS Date), 2, 15, 0.04)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (187, N'HW-187', N'Dụng cụ đào bới', 10, 217000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/237_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (188, N'HW-188', N'Máy vắt cam', 10, 483000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/238_0.jpg', CAST(N'2019-11-11' AS Date), 1, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (189, N'HW-189', N'Máy say sinh tố', 10, 378000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/239_0.jpg', CAST(N'2019-11-11' AS Date), 2, 15, 0.19)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (190, N'HW-190', N'Máy đánh trứng', 10, 301000, N'- Là dụng cụ đa năng, tiện tích, thuận tiện, nhỏ gọn và dễ sử dụng <br/>- Thiết kế nhiều mẫu mã<br/>- Sản phẩm bền đẹp<br/>- Tiện lợi cho việc di chuyển', N'Home&Garden/240_0.jpg', CAST(N'2019-11-11' AS Date), 3, 15, 0)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (191, N'test', N'test', 10, 150000, N'abc', N'1.jpg', CAST(N'2021-07-10' AS Date), 2, 1, 0.15)
INSERT [dbo].[product] ([id], [code], [name], [quantity], [price], [description], [image], [create_date], [status], [sub_category_id], [sale]) VALUES (192, N'test', N'test', 10, 150000, N'abc', N'1.jpg', CAST(N'2021-07-10' AS Date), 2, 1, 0.1)
