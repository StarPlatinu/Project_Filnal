...
<body>
        ...
        <div class="row">
            <a href="#">
                <img class="img-fluid" style="margin-top: 4.5rem;;" src="static/images/store_coupon.png"
                    alt="static/images/store_coupon.png">
            </a>
        </div>
    </div>
    <!--slider-->
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="static/images/slide1_1.jpg" class="d-block w-100" alt="../static/images/slide1_1.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide1_2.jpg" class="d-block w-100" alt="../static/images/slide1_2.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide1_3.jpg" class="d-block w-100" alt="../static/images/slide1_3.jpg">
            </div>
        </div>
    ...
    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel" data-interval="3010">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="static/images/slide2_1.jpg" class="d-block w-100" alt="static/images/slide2_1.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide2_2.jpg" class="d-block w-100" alt="static/images/slide2_2.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide2_3.jpg" class="d-block w-100" alt="static/images/slide2_3.jpg">
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <!--New Arrivals-->
        <div class="row" style="background-image: url('static/images/new_arrival.jpg')">
    ...
    <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="static/images/slide3_1.jpg" class="d-block w-100" alt="static/images/slide3_1.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide3_2.jpg" class="d-block w-100" alt="static/images/slide3_2.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide3_3.jpg" class="d-block w-100" alt="static/images/slide3_3.jpg">
            </div>
            <div class="carousel-item">
                <img src="static/images/slide3_4.jpg" class="d-block w-100" alt="static/images/slide3_4.jpg">
            </div>
        </div>
    ...
    <div id="carouselExampleIndicators4" class="carousel slide" data-ride="carousel" data-interval="2500">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active carousel-item-left">
                <img src="static/images/slide4_1.jpg" class="d-block w-100" alt="static/images/slide3_1.jpg">
            </div>
            <div class="carousel-item carousel-item-next carousel-item-left">
                <img src="static/images/slide4_2.jpg" class="d-block w-100" alt="static/images/slide3_2.jpg">
            </div>
        </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <ul class="list-unstyled quick-links">
                        <li><a><i class="fas fa-phone-volume"></i>0123456789</a><a><i
                                    class="fa fa-envelope ml-3"></i>thanhvu1509@gmail.com</a></li>
                        <li><a
